...
- [ ] Player always-running movement
- [ ] Direction change input
- [ ] Single room test environment
- [ ] Basic collision

### Phase 2: Combat System
- [ ] Contact damage on enemies
- [ ] Enemy hit feedback
...
- **E** - Interact (pickup treasure, etc.)
...
- **PlayerCore** - Central service locator
- **PlayerInputService** - Input handling
- **PlayerMovementService** - Always-running movement
- **PlayerStatsService** - Health, stats, buffs
- **PlayerCameraService** - Camera following
